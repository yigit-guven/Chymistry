...
public class CrucibleScreen extends AbstractContainerScreen<CrucibleMenu> {
    private static final Identifier TEXTURE = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/crucible_gui.png");
    private static final Identifier ARROW_FULL = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/crucible_arrow_full.png");
    private static final Identifier FIRE_EMPTY = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/empty_fire.png");
    private static final Identifier FIRE_FULL = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/full_fire.png");
    private static final Identifier SNOW_EMPTY = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/empty_snow.png");
    private static final Identifier SNOW_FULL = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/full_snow.png");

    private static final Identifier CRUCIBLE_SLOT_ICON = Identifier.fromNamespaceAndPath(Chymistry.MODID,
            "textures/gui/cruciblecontainersloticon.png");
    ...
    private static final int GAP_START_X = 94;
    private static final int GAP_END_X = 117;
        ...
        if (pMouseX >= heatIndicatorX && pMouseX < heatIndicatorX + HEAT_WIDTH &&
            ...
            if (player != null) {
                for (int i = 0; i < player.getInventory().getContainerSize(); i++) {
                    if (player.getInventory().getItem(i).getItem() == net.yigitguven.chymistry.item.ModItems.THERMOMETER
                            .get()) {
                        hasThermometer = true;
                        break;
                    }
            ...
            if (hasThermometer) {
                ...
                if (currentHeat >= 0) {
                    line1 = Component
                            .translatable("tooltip.chymistry.iron_tongs.heat",
                                    Component.literal(String.valueOf((int) currentHeat))
                                            .withStyle(net.minecraft.ChatFormatting.RED))
                            .withStyle(net.minecraft.ChatFormatting.GRAY);
                    line2 = Component.translatable("tooltip.chymistry.crucible.max_heat", String.valueOf((int) maxHeat))
                    ...
                    line1 = Component
                            ...
                            .withStyle(net.minecraft.ChatFormatting.GRAY);
                    line2 = Component.translatable("tooltip.chymistry.crucible.min_heat", String.valueOf((int) minHeat))
                            .withStyle(net.minecraft.ChatFormatting.DARK_GRAY);
                }
    ...
    private void renderHeatIndicator(GuiGraphicsExtractor pGraphics, int x, int y) {
        ...
        if (currentHeat >= 0) {
            pGraphics.blit(RenderPipelines.GUI_TEXTURED, FIRE_EMPTY, heatIndicatorX, heatIndicatorY, 0f, 0f, HEAT_WIDTH,
                    HEAT_HEIGHT, HEAT_WIDTH, HEAT_HEIGHT);
            ...
            if (currentHeat > 0) {
                ...
                if (steps > 0) {
                    ...
                    pGraphics.blit(RenderPipelines.GUI_TEXTURED, FIRE_FULL, heatIndicatorX,
            ...
            pGraphics.blit(RenderPipelines.GUI_TEXTURED, SNOW_EMPTY, heatIndicatorX, heatIndicatorY, 0f, 0f, HEAT_WIDTH,
                    HEAT_HEIGHT, HEAT_WIDTH, HEAT_HEIGHT);
            ...
            if (steps > 0) {
                int fillHeight = steps + 1;
                pGraphics.blit(RenderPipelines.GUI_TEXTURED, SNOW_FULL, heatIndicatorX,
                        heatIndicatorY + HEAT_HEIGHT - fillHeight,
                        0f, (float) (HEAT_HEIGHT - fillHeight),
                        HEAT_WIDTH, fillHeight, HEAT_WIDTH, HEAT_HEIGHT);
            }
        ...
        if (maxProgress > 0 && progress > 0) {
            ...
            if (activePixels > 0) {
                if (activePixels <= gapStart) {
                    pGraphics.blit(RenderPipelines.GUI_TEXTURED, ARROW_FULL, x + arrowX, y + arrowY, 0f, 0f,
                            activePixels, ARROW_HEIGHT, ARROW_WIDTH, ARROW_HEIGHT);
                } else {
                    pGraphics.blit(RenderPipelines.GUI_TEXTURED, ARROW_FULL, x + arrowX, y + arrowY, 0f, 0f, gapStart,
                            ARROW_HEIGHT, ARROW_WIDTH, ARROW_HEIGHT);

                    int remainingPixels = activePixels - gapStart;
                    pGraphics.blit(RenderPipelines.GUI_TEXTURED, ARROW_FULL, x + arrowX + gapEnd, y + arrowY,
                            (float) gapEnd, 0f, remainingPixels, ARROW_HEIGHT, ARROW_WIDTH, ARROW_HEIGHT);
                }
            }
        }
    }
