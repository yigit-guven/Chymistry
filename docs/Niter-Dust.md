...
## Acquisition
Niter Dust is obtained through [Production Composting](Production-Composting). By right-clicking a completely full **Level 7 Composter** with **[Ash](Ash)**, it converts into a Niter Soil Composter which yields Niter Dust when right-clicked (or broken).
